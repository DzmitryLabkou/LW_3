package bsu.rfe.java.group9.lw3.LabCow.varA6;
	...
	public MainFrame(Double[] coefficients) {
		...
		Action seeMoreAboutAuthor = new AbstractAction("О программе") {
			public void actionPerformed(ActionEvent event) {
				JOptionPane.showMessageDialog(MainFrame.this, "Автор: Лобков Д.С., гр. 9", "Об авторе", JOptionPane.INFORMATION_MESSAGE);
			}
		};
